...
driver_path = '/content/drive/MyDrive/DL_2018/generative_inpainting/'
...
if __name__ == "__main__":
    ...
    log_prefix = driver_path+'model_logs/' + '_'.join([
	...
	ng.callbacks.ModelRestorer(trainer.context['saver'], dump_prefix=driver_path+'model_logs/'+config.MODEL_RESTORE+'/snap', optimistic=True),
